...
`id_model` int(11) NOT NULL COMMENT 'Model ID',
  ...
  `description` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Model description',
  `front` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Front description',
  `back` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Back information',
  `neck` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Neck description',
  `arm` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Arm description',
  `observations` varchar(5000) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Other observations',
  ...
  `creation_date` bigint(11) UNSIGNED NOT NULL COMMENT 'Creation date',
